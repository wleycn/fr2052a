...
with deposit_detail as (
    ...
    group by report_date, entity_code, product_category, customer_segment, currency_code, maturity_bucket
...
secured_detail as (
    ...
    group by report_date, entity_code, transaction_type, counterparty_type, currency_code, maturity_bucket
...
loan_detail as (
    ...
    group by report_date, entity_code, loan_type, borrower_type, currency_code, maturity_bucket
...
hqla_detail as (
    ...
    group by report_date, entity_code, security_type, issuer_type, currency_code, maturity_bucket
...
contingent_detail as (
    ...
    select
        ...
        cast(0 as decimal(20, 2)) as market_value
    from {{ ref('owd_off_bs') }}
    group by report_date, entity_code, commitment_type, counterparty_type, currency_code, maturity_bucket
