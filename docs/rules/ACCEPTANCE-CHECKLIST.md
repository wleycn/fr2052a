...
| # | 检查项 | 标准 | 状态 | 证据 |
|---|--------|------|------|------|
| 1 | 全链路时长 | ≤ 15 分钟 | ✅ | 重置后重跑实测 **3 分 11 秒**（16 个环节，含 dbt 16 个模型与 10 次 Spark 作业：ref-load / ods-replay / bronze-load / dq-rules / export-pg / owd-scd2 / verify-bronze / verify-silver / verify-scd2 / verify-ads） |
